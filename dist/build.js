...
Component.options.__file = "C:\\Users\\Sam\\Documents\\Git\\ElectroGloss\\app\\App.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-633e31e0", Component.options)
  } else {
    hotAPI.reload("data-v-633e31e0", Component.options)
  }
})()}
    ...
    computed: {
        ...
        ymlOutput: function () {
            ...
            for (var i = 0; i < this.terms.length; i++) {
                ...
                if (this.terms[i].tags.length > 0) output += '  - [' + this.terms[i].tags.join(', ') + ']\n';

                if (this.terms[i].otherNames.length > 0) output += '  - ' + this.terms[i].otherNames.join(', ') + '\n';

                if (this.terms[i].disambiguations.length > 0) output += '  - ' + this.terms[i].disambiguations.map(function (item) {
                    return '\xAC' + item;
                }).join(', ') + '\n';
            }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('h1', [_vm._v("ElectroGloss")]), _vm._v(" "), _c('h3', [_vm._v("Add a Term")]), _vm._v(" "), _c('form', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newTerm.name),
      expression: "newTerm.name"
    }],
    ...
    on: {
      "input": function($event) {
        ...
        _vm.newTerm.name = $event.target.value
      }
    }
  })]), _vm._v(" "), _c('div', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newTerm.description),
      expression: "newTerm.description"
    }],
    staticClass: "u-full-width",
    attrs: {
      "type": "text",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newTerm.description = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "row"
  ...
  }, [_vm._v("Tags")]), _vm._v(" "), _vm._l((_vm.newTerm.tags), function(tag) {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newTerm.newTag),
      expression: "newTerm.newTag"
    }],
    ref: "newTag",
    staticClass: "u-full-width",
    attrs: {
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newTerm.newTag = $event.target.value
      }
    }
  }), _vm._v(" "), _c('button', {
    on: {
  ...
  }, [_vm._v("Other Definitions")]), _vm._v(" "), _vm._l((_vm.newTerm.otherNames), function(otherName) {
    return _c('div', [_c('input', {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: (otherName.value),
        expression: "otherName.value"
      }],
      staticClass: "u-full-width",
      attrs: {
        "type": "text",
      ...
      on: {
        "input": function($event) {
          if ($event.target.composing) { return; }
          otherName.value = $event.target.value
        }
      }
    })])
  }), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newTerm.newOtherName),
      expression: "newTerm.newOtherName"
    }],
    ref: "newOtherName",
    staticClass: "u-full-width",
    attrs: {
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newTerm.newOtherName = $event.target.value
      }
    }
  }), _vm._v(" "), _c('button', {
    on: {
      "click": function($event) {
        $event.preventDefault();
        _vm.addNewOtherName($event)
      }
    }
  }, [_vm._v("Add Other Definition")])], 2), _vm._v(" "), _c('div', {
    staticClass: "four columns"
  }, [_c('label', {
    attrs: {
      "for": "termName"
    }
  }, [_vm._v("Disambiguation")]), _vm._v(" "), _vm._l((_vm.newTerm.disambiguations), function(disambiguation) {
    return _c('div', [_c('input', {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: (disambiguation.value),
        expression: "disambiguation.value"
      }],
      staticClass: "u-full-width",
      attrs: {
        "type": "text",
      ...
      on: {
        "input": function($event) {
          if ($event.target.composing) { return; }
          disambiguation.value = $event.target.value
        }
      }
    })])
  }), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newTerm.newDisambiguation),
      expression: "newTerm.newDisambiguation"
    }],
    ref: "newDisambiguation",
    staticClass: "u-full-width",
    attrs: {
      "type": "text",
      "placeholder": "Disambiguation",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newTerm.newDisambiguation = $event.target.value
      }
    }
  }), _vm._v(" "), _c('button', {
    on: {
      "click": function($event) {
        $event.preventDefault();
        _vm.addNewDisambiguation($event)
      }
    }
  }, [_vm._v("Add Disambiguation")])], 2)]), _vm._v(" "), _c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-633e31e0", module.exports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assets_css_normalize_css__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assets_css_normalize_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__assets_css_normalize_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_css_skeleton_css__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_css_skeleton_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__assets_css_skeleton_css__);





__WEBPACK_IMPORTED_MODULE_0_vue_dist_vue___default.a.component('term-list', {
    props: ['term'],
...
__WEBPACK_IMPORTED_MODULE_0_vue_dist_vue___default.a.component('yml-preview', {
    props: ['yml'],
...
new __WEBPACK_IMPORTED_MODULE_0_vue_dist_vue___default.a(__WEBPACK_IMPORTED_MODULE_1__App_vue___default.a).$mount('#app');
